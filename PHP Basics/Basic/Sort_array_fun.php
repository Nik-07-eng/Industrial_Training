...
$a=array(10,20,34,2);
echo"Sorting an Array in Ascending order based on their values :";
sort($a);
foreach($a as $val)
{
echo " ".$val;
...
rsort($a);
echo"<br>Sorting an Array in descending order based on their values :";
foreach($a as $val)
{
echo " ".$val;
}
...
echo"<br>Sorting an  Associative array in Ascending order using sort():";
...
echo"<br>The arsort() function sort in descending order based on their values:";
arsort($b);
...
echo"<br>The krsort() function sort in descending order based on their keys:";
krsort($b);
print_r($b);
